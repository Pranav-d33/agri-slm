...
GAPS = [
    "NARP zone->district lists: 115/125 zones carry found_in district relations (mainland + single-zone NEH/islands via ICAR-CRIDA CCP district profiles; 16 zones reverse-mapped from district narp_zone attributes). Remaining 10: Telangana zones (2, districts lack zone attrs), Assam NE zones (2), Bihar central plateau (1), Gujarat south-Gujarat alluvial (1), J&K valley-temperate & cold-arid (2, district attrs use JK-1/2/3 codes), Karnataka NE transition (1), Maharashtra sub-montane (1) = counted TODO",
    ...
    "Market: MSP year series 2010-11..2026-27 in 28 crops encoded from CACP. Mandi price time series (AGMARKNET 2.0 API + data.gov.in both JWT/api-key auth-gated; no anonymous bulk export) = counted TODO",
