...
GAPS = [
    ...
    "Crops: notified variety registry = 114/116 concrete crops carry verifiable variety data (apple CITH-Ammol/Priame/Pride + Shalimar, sapota 8 TNAU, peach PAU Shan-e-Punjab/Pratap/Flordasun/Flordaprince, khesari Ratan/Prateek/Mahateora/Nirmal/Moti/Pusa-24, horse-gram, moth-bean, mesta AMV-7/JBMP3/Shakti, cabbage, sugar-beet LS-6/ISRI Comp-1/Pant S-10, clove PPI(CL)1 from SATHI CSC meeting minutes + gazette + institute records; fodder: guinea grass Selection 1 (CSC54), napier Culture 4/Culture 21/CO(BN)5/BNH10/PBN342 (CSC54/67/79)). 7 crops recorded with notified_status='none' (no officially notified variety exists; commercial cultivars listed): jackfruit, pear, pineapple, strawberry, plum, vanilla, asafoetida — verified across ICAR-IIHR, ICAR-CCARI, IARI, ICAR-IISR, PIB, PAU = closed. 2 fodder crops (lucerne, stylo) carry released varieties not yet enumerated = counted TODO",
    ...
    "Location: district-level attributes = 738/784 districts carry major_crops (zone/soil/crops for 576 via ICAR-CRIDA CCP district PDFs; major crops for ~160 more via DES APY district-level APY report builder (des-apy-district), incl. 81 post-2014 split districts matched from DES crop production data; 4 via HSAG 2024 top-producing-district tables). Remaining 46: post-2022-23 split districts (Polavaram, Bichom, Keyi Panyor, Bajali, Sribhumi, Tamulpur, Kushavati, Vav-Tharad, Hansi, Maihar, MAUGANJ, Pandhurna, Meluri, Rajasthan 2023 splits) absent from DES APY, city-districts with no APY coverage (Delhi 13, Mumbai, Mumbai Suburban, Kolkata, Lakshadweep), and Manipur 2016 splits (Jiribam, Kakching, Kamjong, Kangpokpi, Noney, Pherzawl, Tengnoupal) that DES reports no crop data for = counted TODO",
]
