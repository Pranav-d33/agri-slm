...
GAPS = [
    ...
    "Location: district-level attributes = 661/784 districts carry major_crops (zone/soil/crops for 576 via ICAR-CRIDA CCP district PDFs; major crops for ~80 more via DES APY district export; 4 via HSAG 2024 top-producing-district tables). Remaining 123: post-2014 split districts absent from both CRIDA (2013-era) and APY (pre-2014 data), plus Delhi/Ladakh/A&N/Lakshadweep with no CRIDA or APY coverage = counted TODO",
]
